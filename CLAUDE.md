...
- **The bot runs on cron; webhooks are not installed.** A merged change here has no effect until
  the next scheduled run. That is expected — do not debug it as a failure.
